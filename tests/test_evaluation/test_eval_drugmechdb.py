...
from semantic_llama.evaluation.drugmechdb.datamodel.drugmechdb import Graph, Mechanism
from semantic_llama.evaluation.drugmechdb.eval_drugmechdb import EvalDrugMechDB, _fix_source_mechanism
...
class TestDrugMechDB(unittest.TestCase):
    ...
    def test_training_set(self):
        ...
        t = dict(base_model="text-davinci-003",
    ...
    def test_eval_fine_tuned_extraction(self):
        ...
        evaluator.extractor = TextModelKnowledgeEngine("drug.DrugMechanism", engine=ft)
