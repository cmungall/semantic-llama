...
from semantic_llama.templates.mendelian_disease import MendelianDisease
...
class EvalHPOA(EvaluationEngine):
    ...
    def __post_init__(self):
        self.extractor = TextModelKnowledgeEngine("mendelian_disease.MendelianDisease")
